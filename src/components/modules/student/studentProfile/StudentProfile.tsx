...
const StudentProfileCard: React.FC<Props> = ({ student, user }) => {
  return (
    <Card>
      <div className="flex flex-col mx-auto md:flex-row items-start md:items-center gap-6 p-4 md:p-6">
        <Image
        ...
        />
        <div className="flex-1 grid grid-cols-1 sm:grid-cols-2 md:grid-cols-2 lg:grid-cols-4 gap-4 w-full">
          {/* Name */}
